...
function filterLibraryCategories(
...
function buildTableRows(categories: LibraryCategory[]): TableViewRow[] {
...
function buildMindMapTree(categories: LibraryCategory[]): MindMapNode {
  return {
    id: "root",
    label: "我的知识库",
    type: "root",
